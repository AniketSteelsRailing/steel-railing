...
const WindowProject = ({ windows }: { windows: WindowProjectProps[] }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="items-center justify-center mb-12">
          ...
          <p className="mt-6 text-lg text-textColor text-center">
            Upgrade your property with our high-quality, custom-made windows.
            Expertly designed to fit your style, our windows bring natural
            light, <br />
            energy efficiency, and sophisticated charm to your home.
          </p>
        </div>
